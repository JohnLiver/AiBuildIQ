...
const rightContent = {
    ...
    subtitles: [
        {
            title: "Address:",
            description: "US Admin Office AIBUILDIQ LLC 24211 CAFE HILL SAN ANTONIO, TX 78260"
        },
        {
            ...
            <div className="mx-auto px-4 py-8">
                ...
                <div className="md:flex justify-between">
                    <div className="md:w-1/2 p-4">
                        <p>&copy; 2020 - 2024 All Rights Reserved. <Link href="https://aibuildiq.com" className="underline text-gray-200 hover:text-gray-300">aibuildiq.com</Link></p>
                    </div>
